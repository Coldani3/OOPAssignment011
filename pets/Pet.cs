...
namespace OOPAssignment011
{
    public class Pet : IUpdating
    {
        ...
        public void Update()
        {
            ...
            float MoodDecayRate = (this.Hunger >= 50 ? 2.0f : 1.5f) + (0.25f * (((temperatureDifference - 10) >= 0 ? (temperatureDifference - 10) : 0) / 8.0f)) * (this.IsSick ? 2.5f : 1.0f) * (!this.Capabilities.CanFly && this.Room.SkyEnvironment ? 2.0f : 1.0f);
